...
Route::middleware(['auth'])->group(function () {
    ...
    Route::resource('box-log', 'BoxLog\IndexController');
    Route::post('box-report', 'BoxLog\IndexController@report')->name('box-report');
    Route::resource('box-stock', 'BoxesStock\IndexController');
